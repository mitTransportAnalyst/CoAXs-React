        ...
        <Modal show={this.props.isShow} onHide={this.props.closeModal} keyboard={false} backdrop="static">
          ...
          <Modal.Body>
            ...
            <ol>
              ...
              <li>Drag the time slider on the right hand side to see how far you can travel in different amounts of
                time. Consider how this compares with your experience of your most frequent trips.
              </li>
              <li>Notice how many jobs you can access at different time cutoffs by looking at the graph on the right
                hand side of the screen.
              </li>
              <li>Once you’re finished exploring, click the button on the right hand side that says “Click here to go to
