        ...
        <Modal show={this.props.isShow} onHide={this.props.closeModal} keyboard={false} backdrop="static">
          ...
          <Modal.Body>
            ...
            <ul>
              ...
              <li><strong>3 Compare your scenario:</strong> Once you’ve created the scenario you want to test, click
                “Update” to see how this compares to today’s service.
              </li>
              <li><strong>4 Explore your scenario:</strong> Just like before, change the time slider to see how access
                to jobs changes, and you can also move the blue pin around to see how your scenario would impact
                different parts of the city.
              </li>
            </ul>
            <p>
              <strong>Quick tip:</strong> in general, placing the pin near an end of one of the transit routes you’re
              upgrading in the scenario will enable you to see the greatest impacts. Though sometimes, benefits may be
              significant not just for communities at the ends of lines; use your intuition and knowledge of the transit
              network in your city to explore where the impacts might be the most significant.</p>
          </Modal.Body>
          <Modal.Footer>
