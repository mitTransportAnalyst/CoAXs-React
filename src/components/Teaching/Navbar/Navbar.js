      ...
      <div className="navbarTop">
        <div className="arrow-steps">
          ...
          <div className="step" ref="target">
            <a href="http://coaxs.herokuapp.com/landingnola" target="_blank">1 Home Page</a>
          </div>

          <div className={introClass}>
              <span className="">2 Get to know CoAXs
                <OverlayTrigger placement="bottom" overlay={tooltipforIntro}>
                  <a ref="introQuestion" className="fa fa-question-circle-o questionMark"
                     style={{display: "inline", fontSize: 16}} aria-hidden="true" onClick={this.handleClickIntro}
                     href="#"/>
                </OverlayTrigger>
              </span>
          </div>
          ...
          <div className={compareClass}>
            <span>3 Create Your Own Scenario
              <OverlayTrigger placement="bottom" overlay={tooltipforIntro}>
                <a ref="compareQuestion" className="fa fa-question-circle-o questionMark"
                   style={{display: "inline", fontSize: 16}} aria-hidden="true" onClick={this.handleClickScenario}
                   href="#"/>
              </OverlayTrigger>
            </span>
          </div>
